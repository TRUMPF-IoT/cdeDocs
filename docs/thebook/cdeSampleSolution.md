...
9) Click on the V-Things List and create a new Virtual Sensor. Since we have not turned on the KPIs for Node2, installed any other pl
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk3MTI2MjAzNSwtMTIxNzgzMzIwMywzOD
